...
<form id="editViolationForm{{ $recentViolationsToday->id }}"  action="{{ route('updatedetailadmitted', ['id' => $recentViolationsToday->id]) }}" method="POST" enctype="multipart/form-data">
@csrf
@method('PUT')
<div class="container">
<div class="row">
...
<table class="table table-bordered">
    <tbody>
        <tr>
            <th>Admitted No.</th>
            <td>
                <input type="text" class="form-control" id="resolutionNo{{ $recentViolationsToday->id }}" name="admittedno" value="{{ $recentViolationsToday->admittedno }}">
            </td>
        </tr>
        <tr>
            <th>TOP</th>
